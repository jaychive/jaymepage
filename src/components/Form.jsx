...
function Form(props) {
  ...
  const onSubmit = (data) => {
    ...
    axios.post('/jayme', { headers: { "Content-Type": `application/json` }, body: JSON.stringify(data) })
      .then(res => {
        if (res.data === '성공') {
          axios.get('/jayme')
            .then(res => {
              let postedData = res.data
  ...
  return (
    <>
      <section id="form" className="container mx-auto px-4">
        ...
        <div className="flex justify-center pt-5">
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col px-1">
            ...
            <FormGroup className="justify-between">
            ...
            <div className="flex">
              ...
              <div className="ml-4 auto-cols-auto">
                <TextField
                  name="fo_kakaoid"
                  id="fo_kakaoid"
            ...
            <div className="pb-5">
              <ButtonBase type="submit" className='w-fit text-white lexend' disabled={isSubmitting}>
                SUBMIT
              </ButtonBase>
            </div>
          </form>
