  ...
  return (
    <>
      <section id="contact" className="container mx-auto px-4">
        ...
        <div className="ctbox">
          <img src="/img/sub/sub03.svg" alt="" className="block mx-auto w-6 py-5" />
          <div className="ctdetail">
            ...
            <img src="/img/sub/sub03.svg" alt="" className="block mx-auto w-3 py-5" />
            <div className="social">
              <h4 className="text-lg lexend font-normal mb-3">Social</h4>
              <div className="w-fit mx-auto">
                <a href="http://" target="_blank" rel="noopener noreferrer" className="snslink py-1 flex justify-center items-center lexend text-base text-slate-600 w-fit mx-auto relative">
        ...
        <Link to="/contact/me">
          <button className="squareBtn border border-dark py-3 px-2">CONTACT ME</button>
        </Link>
      </section>
    </>
  );
